...
- 接口基准地址：`http://82.157.62.161:8001/`
- 服务端已开启 CORS 跨域支持
- API 认证统一使用 Token 认证
...
```json
{
  ...
  "data": {
    "id": "123",
     "name": "你好",
    "token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJwYXNzd29yZCI6IjEyMyIsImlkIjoxMjN9.y4PnsqSEzp1PvStwMHyKFIfealf1Ja_aGvHtUuXg0Fg"
  },
  "message": "登录成功！"
}
```
...
```json
{
  "code": 200,
  "data": {
    "token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJwYXNzd29yZCI6IjEyMyIsImlkIjoxMjMsInJpZCI6MX0.acPQqsJiyUPOVtT8zSJrqFjSyeKeCwI-4WadCo9vnkk"
  },
  "message": "登录成功！"
}
```
